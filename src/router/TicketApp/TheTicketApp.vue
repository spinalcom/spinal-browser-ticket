...
import { getTicketDescription } from '../../compoments/TabManager/generic/NodeTickets/Ticket';
...
import NodeTicketsSelectedVue from '../../compoments/TabManager/generic/NodeTickets/NodeTicketsSelected.vue';
...
export default {
  ...
  methods: {
    ...
    zoomOn() {
      EventBus.$emit("test-zoom-all", { server_id: this.currentView.serverId });
    },

    isolateAll() {
      EventBus.$emit("test-isolate-all", { server_id: this.currentView.serverId });
    },

    selectInView() {
      EventBus.$emit("test-select-item", { server_id: this.currentView.serverId });
    },
