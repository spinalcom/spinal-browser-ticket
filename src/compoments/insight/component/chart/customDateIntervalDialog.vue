...
<template>
  <md-dialog class="endpoint-chart-viewer-panel-dialog-custom-interval" :md-active.sync="isOpenComputed"
    ...
    <md-dialog-actions>
      ...
      <md-button class="md-primary" :disabled="start === null || end === null" @click="closeDialog(true)">Valid
      </md-button>
    </md-dialog-actions>
  </md-dialog>
</template>
...
<style>
  ...
  .endpoint-chart-viewer-panel-dialog-custom-interval>.md-dialog-container>.md-dialog-content.md-scrollbar::-webkit-scrollbar {
    background-color: #121212;
  }

  .endpoint-chart-viewer-panel-dialog-custom-interval>.md-dialog-container>.md-dialog-content.md-scrollbar::-webkit-scrollbar-thumb {
